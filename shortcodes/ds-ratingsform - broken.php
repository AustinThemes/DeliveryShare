...
$DriverName = sanitize_text_field( $_GET['driver'] );
...
<div id="WD-RatingForm" class="WD-RatingForm woocommerce">
    ...
    if ($posts->have_posts()){
        while ($posts->have_posts()):
            ...
            ?>
      <option value="<?php echo $WDorderID; ?>"><?php echo '#' . $WDorderID . ' | ' . $WDorderAssignedDriver; ?></option>
      <?php  }      
   endwhile;
   }
    ?>
  ...
  <p class="form-row form-row-first">
    ...
    <div id="ds-stars-container">
      <img src="<?php echo $WD_images_folder; ?>ds-rating-star-on.png" onClick="SetRatingTo(1)" onMouseOver="ChangeRatingStarsTo(1)" />
      <img src="<?php echo $WD_images_folder; ?>ds-rating-star-on.png" onClick="SetRatingTo(2)" onMouseOver="ChangeRatingStarsTo(2)" />
      <img src="<?php echo $WD_images_folder; ?>ds-rating-star-on.png" onClick="SetRatingTo(3)" onMouseOver="ChangeRatingStarsTo(3)" />
      <img src="<?php echo $WD_images_folder; ?>ds-rating-star-on.png" onClick="SetRatingTo(4)" onMouseOver="ChangeRatingStarsTo(4)" />
      <img src="<?php echo $WD_images_folder; ?>ds-rating-star-on.png" onClick="SetRatingTo(5)" onMouseOver="ChangeRatingStarsTo(5)" />
    ...
    <input id="WDrating" type="hidden" value="5" class="input-text" onChange="ChangeRatingStarsTo(this.value)" />
            ...
            <p align="left">
                <input type="submit" class="button" id="WDratingSubmitButton" value="Rate Driver 5 Stars" />
            </p>
